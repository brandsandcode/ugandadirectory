    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">Hotel <span class="sr-only">(current)</span></a></li>
                <li><a href="#">Apartments</a></li>
                <li><a href="#">Safari Lodges</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="#">Wakiso</a></li>
                <li><a href="#">Lira</a></li>
                <li><a href="#">Guru</a></li>
                <li><a href="#">Masaka</a></li>
                <li><a href="#">Mpigi</a></li>
                <li><a href="#">Entebbe</a></li>
                <li><a href="#">Busia</a></li>
                <li><a href="#">Jinja</a></li>
                <li><a href="#">Mbale</a></li>
            </ul>
            <button type="button" class="btn btn-default nav-pills">Load More</button>
        </div>
        <img src="logo.png" alt="..." class="img-rounded">
    </div>
</div>
